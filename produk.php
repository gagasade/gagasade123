        ...
        <div class="row">
            <div class="col-lg-3 mb-5">
                ...
                <ul class="list-group">
                    ...
                    <a class="list-group-a" href="produk.php?kategori=<?php echo $kategori['nama']; ?>">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                ...
                                <a href="produk.php?nama=<?php echo $produk['nama']; ?>" class="btn 
